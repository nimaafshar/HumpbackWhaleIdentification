...
TRAIN_DF = '../data_csv/train.csv'
SUB_Df = '../data_csv/sample_submission.csv'
# TRAIN = '/home/vahid/data/whales/train/'
# TEST = '/home/vahid/data/whales/test/'
TRAIN = '/root/data/train/'
TEST = '/root/data/test/'
# TRAIN = '/Users/vahid/Desktop/projects/whale/train/'
# TEST = '/Users/vahid/Desktop/projects/whale/test/'
P2H = '../extra/p2h.pickle'
P2SIZE = '../extra/p2size.pickle'
BB_DF = "../extra/bounding_boxes.csv"
...
f = h5py.File('../models_data/with_color_big115.model', 'r')
...
# if isfile('../models_data/with_color_big.model'):
#     tmp = keras.models.load_model('../models_data/with_color_big.model')
#     model.set_weights(tmp.get_weights())

from keras.models import load_model
# model = load_model('../models_data/with_color_big.model')
tmp = keras.models.load_model('../models_data/with_color_big_with_lap_new.model')
model.set_weights(tmp.get_weights())
print("model loaded")
...
prepare_submission(0.99, 'submission_e_130_new_lap.csv')
toc = time.time()
